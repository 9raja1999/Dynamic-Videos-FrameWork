...
<div id="audios">
	...
	<script>
		...
		// audioChunks.push("Welcome to iParhai!!!"); // intro - same
		// audioChunks.push("Watch The Video!!!"); // frame 1 - same
		// audioChunks.push(greet1+" "+greet2 + "!!! "); // frame 2 - same
		// audioChunks.push(getting1+" "+getting2); // frame 3 - same
		// audioChunks.push(learn1+" "+type+" from "+dgt.replace("-"," to ")); // frame 4 - same		
		...
		// function audioSetter(audioChunks,pitchSet,volumeSet,rateSet,voiceSet)
		// {
		...
		// 	const pitch = pitchSet;
		// 	speech.pitch = pitch;

		// 	const volume = volumeSet;
		...
		// 	{
		// 		finalSet += audioChunks[i];
		// 	}
			
		// 	speech.text = finalSet;

		// 	speech.voice = voices[voiceSet];

		// 	// Start Speaking
		// 	window.speechSynthesis.speak(speech);
		// }

		function audioSetandPlay(audioChunkSet,pitchSet,volumeSet,rateSet,voiceSet)
		{
			// Initialize new SpeechSynthesisUtterance object
			let speech = new SpeechSynthesisUtterance();
		...
		{		
			...
			let myGreetings = [
				greet1, greet2 , getting1, getting2, learn1, fruitLasts, fruitLast
			]
			

			console.log('My Greetings' , myGreetings);
			// audio chunks setter
		
			audioChunks[0] = "Welcome to iParhai!";

			audioChunks[1] = "Watch The Video!";

			audioChunks[2] = greet1+" "+greet2 + "!!! " + getting1;

			audioChunks[3] = getting2;

			audioChunks[4] = learn1+" "+type+" "+dgt.replace("-"," to ")+"?";

			audioChunks[5] = dgt+"! is equals to "+dgt+" "+fruitLasts+"?";

			audioChunks[6] = "What Did You Learn from this video?";

			audioChunks[7] = +"You Learned How To"+type+" "+dgt+"!";

			audioChunks[8] = "Hope You Understand the lesson!";

			audioChunks[9] = byeText[parseInt(Math.random() * byeText.length)]+" "+greet2+"!";
			
			// Set Parameters - First Step...

			if(type.toLowerCase().includes("geometry") && type.toLowerCase().includes("box") && type.toLowerCase().includes("tools"))
			{	
				
				
				type2 = "cgf2";
				type = "recognize and understand tools of geometry box";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;
				
				let thisAudios = [...audioChunks]
				thisAudios[4] = "Hello Raja Ehsan";
				thisAudios[5] = "Are you fine?";

				audioChunks = thisAudios;
				console.log('Function Audios' , thisAudios)
				console.log('Original Audios' , audioChunks)

				gifSetterUrl = "box1.gif";
				gifSetterUrl2 = "box2.webp";

				subDurationMin = 32000;

				finalFrameSet = 11000;
			}
			else if(type.toLowerCase().includes("tally") && type.toLowerCase().includes("graph"))
			{			
				type2 = "cgf3";
				type = "recognize and understand tally graphs";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;
				...
				gifSetterUrl = "tally1.gif";
				gifSetterUrl2 = "tally2.gif";
				gifSetterUrl3 = "tally3.jpg";
			...
			{			
				type2 = "cgf2";
				type = "recognize and understand temperature using thermometer";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "temp1.webp";
				gifSetterUrl2 = "temp2.webp";
			...
			else if(type.toLowerCase().includes("area") || type.toLowerCase().includes("geometry"))
			{			
				type2 = "cgf3";
				type = "count and calculate area of the square and rectangle";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "area1.webp";
				gifSetterUrl2 = "area2.webp";
				gifSetterUrl3 = "area3.jpg";
			...
			else if(type.toLowerCase().includes("mean") || type.toLowerCase().includes("average"))
			{			
				type2 = "cgf3";
				type = "count and calculate mean (average) of the numbers from";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "mean1.webp";
				gifSetterUrl2 = "mean2.webp";
				gifSetterUrl3 = "mean3.jpg";
			...
			else if(type.toLowerCase().includes("quad") && type.toLowerCase().includes("geometry"))
			{			
				type2 = "cgf3";
				type = "recognize and understand quadrilaterals";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "quad1.webp";
				gifSetterUrl2 = "quad2.webp";
				gifSetterUrl3 = "quad3.jpg";
			...
			else if(type.toLowerCase().includes("comp") && type.toLowerCase().includes("sup") && type.toLowerCase().includes("angles"))
			{			
				type2 = "cgf2";
				type = "recognize and understand Adjacent Complementry and Suplementry Angles";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "comp1.gif";
				gifSetterUrl2 = "sup1.gif";
			...
			else if(type.toLowerCase().includes("triangles"))
			{			
				type2 = "cgf3";
				type = "recognize and understand triangles";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "tri1.webp";
				gifSetterUrl2 = "tri2.webp";
				gifSetterUrl3 = "tri3.jpg";
			...
			else if(type.toLowerCase().includes("angles"))
			{			
				type2 = "cgf3";
				type = "recognize and understand angles";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "angle1.webp";
				gifSetterUrl2 = "angle2.webp";
				gifSetterUrl3 = "angle3.webp";
			...
			else if(type.toLowerCase().includes("ratios"))
			{			
				type2 = "cgf3";
				type = "read and understand ratios from";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "rat1.webp";
				gifSetterUrl2 = "rat2.webp";
				gifSetterUrl3 = "rat3.webp";
			...
			else if(type.toLowerCase().includes("decimal") && type.toLowerCase().includes("fraction"))
			{			
				type2 = "cgf3";
				type = "read and convert decimals to fractions";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "dtf1.webp";
				gifSetterUrl2 = "dtf2.webp";
				gifSetterUrl3 = "dtf3.webp";
			...
			else if(type.toLowerCase().includes("percentage") && type.toLowerCase().includes("fraction"))
			{			
				type2 = "cgf3";
				type = "read and understand percentages and fraction relation";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "per1.webp";
				gifSetterUrl2 = "per2.webp";
				gifSetterUrl3 = "per3.webp";
			...
			else if(type.toLowerCase().includes("lcm"))
			{			
				type2 = "cgf3";
				type = "read and understand LCM";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "lcm1.webp";
				gifSetterUrl2 = "lcm2.webp";
				gifSetterUrl3 = "lcm3.webp";
			...
			else if(type.toLowerCase().includes("prime") && type.toLowerCase().includes("factors") && type.toLowerCase().includes("hcf"))
			{			
				type2 = "cgf3";
				type = "read and understand HCF using prime factors";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "prime1.webp";
				gifSetterUrl2 = "prime2.webp";
				gifSetterUrl3 = "hcf1.webp";
			...
			else if(type.toLowerCase().includes("bodmas") || type.toLowerCase().includes("bidmas"))
			{			
				type2 = "cgf3";
				type = "read and understand bodmas rules";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "bodmas1.gif";
				gifSetterUrl2 = "bodmas2.gif";
				gifSetterUrl3 = "bodmas3.gif";
			...
			else if(type.toLowerCase().includes("division") && type.toLowerCase().includes("fraction"))
			{			
				type2 = "cgf1";
				type = "read and understand division of fractions from";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				...
				gifSetterUrl = "divUFrac.webp";
			}

			else if(type.toLowerCase().includes("multiplication") && type.toLowerCase().includes("fraction"))
			{			
				type2 = "cgf1";
				type = "read and understand multiplication of fractions from";
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				$(".frame-7,.frame-8").remove();
				...
				gifSetterUrl = "mulUFrac.webp";
			}

			else if(type.toLowerCase().includes("prime") && type.toLowerCase().includes("number"))
			{				
				type2 = "cgf2";
				type = "read and understand prime numbers from";				
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;
			...
			else if(type.toLowerCase().includes("place") && type.toLowerCase().includes("value") && type.toLowerCase().includes("billion"))
			{				
				type2 = "cgf2";
				type = "read and count numbers using place values from";				
				subDuration3 = 7000;
				subDuration2 += 15000;
				subDuration4 = -7000;
				deadLock = 1;

				gifSetterUrl = "Large-Numbers-Millions-Billions-1.webp";
				gifSetterUrl2 = "Large-Numbers-Millions-Billions-3.webp";
			...
			else if(type.toLowerCase().includes("compare") && type.toLowerCase().includes("order"))
			{			
				type2 = "cgf3";
...
// alert(audioChunks[2]+audioChunks[3]+audioChunks[4]+audioChunks[5]+audioChunks[6]+audioChunks[7]+audioChunks[8]);
			...
			$(document).ready(function(){	
				...
				{		
					...
					// audioChunks[5] = '536465465656565'+" Let's "+type+" "+arrayOfFgt[0]+" to "+arrayOfFgt[1]+lastAudio6Chunk+"!";	
					
					if(type3.toLowerCase()=="before, between and after" || type3.toLowerCase()=="bigger, smaller, less than and more than")
					{
						audioChunks[6] = secondText+allDigits+" "+repeatText+" ";
						audioChunks[7] = allDigits2+" You Learned How To"+type+" "+dgt+"!";
					}
					else
					{
						// audioChunks[6] = secondText+allDigits+" "+repeatText+" "+allDigits2;
			...
			audioSetandPlay(audioChunks[0],pitchSet,volumeSet,rateSet,voiceSet);
		}
	...
	<script>
		...
		$(document).ready(function(){		
			...
			if(deadLock==1)
			{
				// audioChunks[4] = learn1+" "+type+"?";
				// audioChunks[7] = +"You Learned How To"+type+"!";
			...
			$("#playVideoBtn").click(function(){
				$("#playVideoBtn").fadeOut(1000);
					...
					update: function(anim) {
							...
							if(counterForSpeech == 0)
							{
								counterForSpeech = 1;
								audioSetandPlay(audioChunks[1],pitchSet,volumeSet,rateSet,voiceSet);
							}
					...
					begin: function() {
						...
						var sFrameTime2=2000;					
							...
							{
								counterForSpeech = 2;
								audioSetandPlay(audioChunks[2]+audioChunks[3]+audioChunks[4],pitchSet,volumeSet,rateSet,voiceSet);
							}
						...
						$(".frame-1").fadeIn(sFrameTime2,function(){
							...
							if(counterForSpeech == 2)
							{
								counterForSpeech = 3;
								audioSetandPlay(audioChunks[5]+audioChunks[6]+audioChunks[7],pitchSet,volumeSet,rateSet,voiceSet);
							}
					...
					begin: function() {				
							...
							if(counterForSpeech == 3)
							{
								counterForSpeech = 4;
								audioSetandPlay(audioChunks[8],pitchSet,volumeSet,rateSet,voiceSet);
							}
					...
					begin: function() {		
							...
							if(counterForSpeech == 4)
							{
								counterForSpeech = 5;
								audioSetandPlay(audioChunks[9],pitchSet,volumeSet,rateSet,voiceSet);
							}
